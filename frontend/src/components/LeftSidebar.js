...
const LeftSidebar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      // Only close modal if clicked completely outside modal and not on any interactive element
...
const FormPopup = React.memo(({ sectionId, onClose, theme, modalRef, currentTheme, setCurrentTheme, themes }) => {
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  value={formData.couple_name_1 !== undefined ? formData.couple_name_1 : (weddingData.couple_name_1 || '')}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.couple_name_2 !== undefined ? formData.couple_name_2 : (weddingData.couple_name_2 || '')}
              ...
              <div>
                ...
                <input
                  type="date"
                  value={formData.wedding_date !== undefined ? formData.wedding_date : (weddingData.wedding_date || '')}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.venue_name !== undefined ? formData.venue_name : (weddingData.venue_name || '')}
            ...
            <div>
              ...
              <input
                type="text"
                value={formData.venue_location !== undefined ? formData.venue_location : (weddingData.venue_location || '')}
            ...
            <div>
              ...
              <textarea
                rows={4}
                value={formData.their_story !== undefined ? formData.their_story : (weddingData.their_story || '')}
